package org.apache.cloud.rdf.sparql;
...
import org.apache.cloud.rdf.sparql.templating.BooleanQueryMAVWriterFactory;
...
public class SPARQLController {
    ...
    */
     ...
     */
    @PostConstruct
    public void postConstruct() throws IllegalStateException {
    ...
    private TupleQueryResultWriterFactory getTupleQueryResultWriterFactory(String acceptHeader){        
        ...
        .findFirst()
        .orElseGet(()->{ return TupleQueryResultWriterRegistry.getInstance().get(CONSTANTS.DEFAULT_TUPLE_QUERY_RESULT_FORMAT).get(); });
    }
    ...
    private RDFWriterFactory getRDFWriterFactory(String acceptHeader){        
        ...
        .findFirst()
        .orElseGet(()->{ return RDFWriterRegistry.getInstance().get(CONSTANTS.DEFAULT_RDF_FORMAT).get(); });    
    }
    ...
    private BooleanQueryResultWriterFactory getBooleanQueryResultWriterFactory(String acceptHeader){
        ...
        .findFirst()
        .orElseGet(()->{ return BooleanQueryResultWriterRegistry.getInstance().get(CONSTANTS.DEFAULT_BOOLEAN_QUERY_RESULT_FORMAT).get(); });        
    }    
}
