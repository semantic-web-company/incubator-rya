<%@page import="org.eclipse.rdf4j.query.resultio.BooleanQueryResultWriterRegistry"%>
<%@page import="org.eclipse.rdf4j.query.resultio.BooleanQueryResultWriterFactory"%>
<%@page import="org.eclipse.rdf4j.rio.RDFWriterRegistry"%>
<%@page import="org.eclipse.rdf4j.query.resultio.TupleQueryResultWriterRegistry"%>
<%@taglib prefix="spring" uri="http://www.springframework.org/tags" %>
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%@taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>

<div class="sparql_container">
    <form action="/web.rya/sparql">
        <fieldset>
            <legend>Query</legend>
